// Studio — Save-the-date / invitation mockup tool page.
...
import { InvitationMockupStudio } from "@/components/studio/invitation-mockup-studio";

export const dynamic = "force-dynamic";

export default async function InvitationMockupPage() {
  ...
  const tool = STUDIO_TOOLS["invitation-mockup"];
      ...
      <header className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-1">
          <div className="text-[11px] uppercase tracking-[0.25em] text-stone-500">
            AI Studio · Invitation mockup
          </div>
          <h1 className="font-serif text-4xl font-light tracking-tight md:text-5xl">
            Invitation mockup
          </h1>
          <p className="max-w-2xl text-sm text-muted-foreground">
            Upload a couple photo and tell us your theme — get
            save-the-date and invitation card mockups in four real
            layout variants.
          </p>
        </div>
