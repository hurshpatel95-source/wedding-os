// Studio — Day-of timeline visualizer tool page.
...
import { DayOfVizStudio } from "@/components/studio/day-of-viz-studio";

export const dynamic = "force-dynamic";

export default async function DayOfVizPage() {
  ...
  const tool = STUDIO_TOOLS["day-of-viz"];
      ...
      <header className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-1">
          <div className="text-[11px] uppercase tracking-[0.25em] text-stone-500">
            AI Studio · Day-of visualizer
          </div>
          <h1 className="font-serif text-4xl font-light tracking-tight md:text-5xl">
            Day-of visualizer
          </h1>
          <p className="max-w-2xl text-sm text-muted-foreground">
            Type in your day-of schedule — get a visual timeline you can
            share with vendors and guests. We&apos;ll parse the freeform
            input and render it as a clean, legible card.
          </p>
        </div>
