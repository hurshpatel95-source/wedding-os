...
// Move 2 — Photo → Pricing client UX.
//
// Drop zone + notes + "Analyze" button → POSTs multipart to
// /api/visualize/photo-to-pricing → renders the structured result.
// Stateless — nothing persists. "Analyze another" resets to the
// idle state.
...
export function VisualizeStudio({
  baseCurrency,
  weddingRegion,
}: {
